...
type BackendSpec struct {
	// +optional
	S3 *S3Spec `json:"s3,omitempty" tf:"-"`
	// +optional
	Gcp *GcpSpec `json:"gcp,omitempty" tf:"-"`

	//SecretRef core.LocalObjectReference `json:"secretRef" tf:"-"`
}
...
type GcpSpec struct {
	Bucket      string `json:"bucket" tf:"bucket"`
	Credentials string `json:"credentials" tf:"credentials"`
}
